    ...
    <div className="min-h-screen bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          <p>
            ReFocus ("we", "our", or "us") is a digital-wellness and productivity application
            designed to help you build better focus habits, track your progress, and engage with a
            positive community.
          </p>

          <p>
            Your privacy is extremely important to us. This Privacy Policy explains how we collect,
            use, and protect your information when you use ReFocus.
          </p>
            ...
            <div className="space-y-4 ml-4">
              <div>
                ...
                <p className="text-muted-foreground mb-2">
                  We may collect information that you voluntarily submit when using the app, such
                  as:
                </p>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Account information (name, email, username, password)</li>
                  <li>Profile details (profile picture, bio, interests)</li>
                  <li>Connections &amp; friends (mutual friends, pending connections)</li>
                  <li>Focus session data (duration, timestamps, session type, streak count)</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Usage data (pages visited, buttons clicked, time in app)</li>
                  <li>Device information (browser type, device type, operating system)</li>
                  <li>Log data (IP address, approximate location, errors, performance logs)</li>
                  <li>Cookies or local storage data (preferences, theme mode, session state)</li>
                </ul>
              ...
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">1.3. Optional Data</h3>
                <p className="text-muted-foreground">
                  We may ask to collect:
                </p>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                ...
                <p className="text-muted-foreground mt-3">You can disable these at any time.</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <li>Analyze trends and app performance (e.g., feature usage, time spent on app)</li>
            </ul>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">We take reasonable steps to safeguard your data:</p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">We may use cookies or local storage to:</p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <li>Firebase / Supabase / MongoDB – user accounts &amp; database</li>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">6. Sharing Your Information</h2>
            ...
            <p className="text-muted-foreground mt-4 font-semibold">
              We do not sell or trade your data to advertisers or marketing agencies.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">7. Your Rights &amp; Controls</h2>
